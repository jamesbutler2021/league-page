...
def export_to_github(players, format='1QB', tep=0):
    ...
    github_token = ${{ secrets.GITHUB_TOKEN }}  # Ensure your token is set as an environment variable or replace this line with your token directly
...
if __name__ == "__main__":
    ...
    export_to_github(players, format='1QB', tep=0)
